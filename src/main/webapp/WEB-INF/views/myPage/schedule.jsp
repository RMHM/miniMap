...
<body>
	...
	<div id="wrapper">
		...
		<nav style="float: left; width: 100px; height: auto;">
			<a href="#">쪽지</a><br /> <a
				href="${pageContext.request.contextPath}/myPage/updateMemberView.do">정보수정</a><br />
						...
						<div style="text-align: left;">
							...
							<div style="margin-bottom: 5px;">
								...
								<span style="float: right;"> 날짜 <input type="date"
									id="datepicker_startdate" name="startDateT"
									style="width: 90px;" class="ed hasDatepicker">~<input
									type="date" id="datepicker_enddate" name="endDateT"
