		...
		<div class="container">
			<div class="col-md-2" align="center">
				...
				<ul class="unstyled">
					...
					<li><a href="/board/boardlist4.do" style="color:#8A0829">질문 게시판</a></li>
				</ul>
			</div>
			<div class="col-md-10">
				<div class="ad">
                  ...
                  <tr name="BId" id="${Board.BId }" style="background-color: #EFF8FB; cursor:pointer">
                       ...
                       <td></td>
						...
						<input type="button" value="글쓰기" id=""
							class="btn btn-theme" onclick="location.href='${pageContext.request.contextPath}/board/boardwrite.do?BCode=4'" 
